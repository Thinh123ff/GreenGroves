...
header('Access-Control-Allow-Origin: http://localhost'); // Cho phép CORS từ frontend
...
$username = "root"; // Thay bằng tên người dùng DB của bạn
...
require '../../vendor/autoload.php'; // Cần cài đặt google/apiclient qua Composer

use Google_Client;

$client = new Google_Client();
$client->setClientId('1022441040470-fr7mdmd7jd4pkodqoc2gn2uc3p1lajpv.apps.googleusercontent.com');
$client->setClientSecret('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');
